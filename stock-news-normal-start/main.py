...
data = response.json()
data_1 = float(data['Time Series (Daily)']['2022-05-26']['4. close'])
print(data_1)
...
response_news = requests.get(url="https://newsapi.org/v2/everything?q=tesla&from=2022-04-27&sortBy=publishedAt&apiKey=8b4995564b61465697202f1c7d5d573e")
